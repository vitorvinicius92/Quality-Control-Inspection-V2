...
with col_logo:
    lb = settings_get_logo()
    if lb:
        st.image(Image.open(io.BytesIO(lb)), width=160)
with col_title:
    st.markdown("""
    <div class="app-hero">
      <div>
        <h1>Registro de Não Conformidades</h1>
        <div class="sub">Abrir, acompanhar e encerrar RNCs com fotos, PDF e e-mail automático.</div>
      </div>
    </div>
